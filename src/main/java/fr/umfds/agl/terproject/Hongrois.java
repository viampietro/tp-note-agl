...
/**
 * Interface de l'algorithme hongrois utilisé pour réaliser le couplage maximal de poids max
 */
...
public interface Hongrois {
	 ...
	 * @param phaseNumber : 1 pour une affectation partielle, 2 pour une affectation globale
	 * @return une liste de couples (i, j) qui correspondent aux affectations calculées
	 */
